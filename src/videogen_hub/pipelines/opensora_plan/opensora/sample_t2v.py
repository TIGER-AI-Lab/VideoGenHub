...
import os, sys
from .models.ae import ae_stride_config, getae, getae_wrapper
from .models.ae.videobase import CausalVQVAEModelWrapper, CausalVAEModelWrapper
from .models.diffusion.latte.modeling_latte import LatteT2V
from .models.text_encoder import get_text_enc
...
def parse_args(arg_list):
    ...
    parser.add_argument("--save_img_path", type=str, default="./src/videogen_hub/pipelines/opensora_plan/sample_videos/t2v")
