...
if __name__ == "__main__":
    ...
    parser.add_argument("--ckpt_path", type=str,
                        default="/remote-home/lzy/RGT/experiments/pretrained_models/RGT_x4.pth")
    ...
    parser.add_argument("--use_chop", type=bool, default=True,
                        help='use_chop: True  # True to save memory, if img too large')
