...
class OpenSora12:
    def __init__(self, device="gpu"):
        ...
        from videogen_hub.pipelines.opensora12.scripts.inference import main
        ...
        self.config = {
            ...
            "model": {
                ...
                "from_pretrained": "checkpoints/hpcai-tech/OpenSora-STDiT-v3",  # Path to pretrained checkpoint
